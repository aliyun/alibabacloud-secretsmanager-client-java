...
## 客户端配置说明
此客户端支持两种配置方式
1. 使用默认配置文件(secretsmanager.properties) [点击查看配置文件设置详情](README_config.zh-cn.md)
2. 使用自定义配置文件(支持相对路径，绝对路径以及classpath读取)，可参考如下示例代码 [点击查看配置文件设置详情](README_config.zh-cn.md)
```java
