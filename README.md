...
* Build Secrets Manager Client by a custom configuration file (you can customize the file name or file path + file name) ([Profile Setting Details](README_config.md))
